...
class Patient(models.Model):
    ...
    categorie = models.CharField(max_length=1, choices=[('A', 'Adulte'), ('E', 'Enfant')])
...
class SessionPatient(models.Model):
    ...
    facture_liee = models.ForeignKey("ventes.FactureVente", on_delete=models.CASCADE, blank=True, null=True)
